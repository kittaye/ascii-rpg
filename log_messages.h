#define LOGMSG_PLR_GET_GOLD_SINGLE "Hero picked up %d gold piece."
#define LOGMSG_PLR_GET_GOLD_PLURAL "Hero picked up %d gold pieces."
#define LOGMSG_PLR_USE_FOOD "Hero restored %d health from eating food."
#define LOGMSG_PLR_USE_FOOD_FULL "Hero is full, but ate the food anyway."
#define LOGMSG_PLR_GET_MAP "Hero found the Map! The floor's layout has been revealed."
#define LOGMSG_PLR_GET_ITEM "Hero picked up %s."
#define LOGMSG_PLR_INVENTORY_FULL "Hero's inventory is full."
...
#define LOGMSG_PLR_BUY_FULL_MERCHANT "Merchant: \"Seems like you don't have any room in your inventory to buy this.\""
